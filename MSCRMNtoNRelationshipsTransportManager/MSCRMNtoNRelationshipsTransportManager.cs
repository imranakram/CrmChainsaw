...
namespace MSCRMToolKit
{
    ...
    public class MSCRMNtoNAssociationsTransportManager : MSCRMToolKitProfileManager
    {
        ...
        public void WriteNewImportFailureLine(NtoNRelationshipsImportFailure failure, string importFailuresReportFileName)
        {
            ...
            //StreamWriter writer = new StreamWriter(importFailuresReportFileName.Replace(".xml", ".txt"), true);

            //DataContractSerializer ser = new DataContractSerializer(typeof(String));

            //string msg = " !! ERROR !! - " + failure.CreatedOn + "| Entity impacted: " + failure.NtoNRelationshipName + " | Reason: " + failure.Reason + " | Source-URL: " + failure.UrlEntity1 + " | Target-URL: " + failure.UrlEntity2;
